...
-   
    ...
    -   inside the local repo (/Users/anavaz/Stuff/current_work/2022_red_snapper/SEFSC-SFD-GMFD-RedSnapperConnectivity)
...
-   
    ...
    -   
        ...
        -   Render Quarto to convert the qmd files to markdown (via GitHub flavored markdown, gfm)
